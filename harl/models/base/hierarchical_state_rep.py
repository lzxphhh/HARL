...
class Hierarchical_state_rep(nn.Module):
    ...
    def reconstruct_info(self, obs):
        ...
        return reconstructed['hdv_stats'], reconstructed['cav_stats'], reconstructed['all_lane_stats'], \
            reconstructed['road_structure'], reconstructed['bottle_neck_position'], \
            reconstructed['target'], reconstructed['self_stats'], reconstructed['executed_action'], reconstructed['generation_action'], \
    ...
    def forward(self, obs, batch_size=20):
        ...
        hdv_stats_hist_5, cav_stats_hist_5, all_lane_stats_5, _, _, _, self_stats_hist_5, exe_action_hist_5, gen_action_hist_5, surround_hdv_hist_5, surround_cav_hist_5, ego_lane_hist_5, left_lane_hist_5, right_lane_hist_5 = self.reconstruct_info(history_5)
        hdv_stats_hist_4, cav_stats_hist_4, all_lane_stats_4, _, _, _, self_stats_hist_4, exe_action_hist_4, gen_action_hist_4, surround_hdv_hist_4, surround_cav_hist_4, ego_lane_hist_4, left_lane_hist_4, right_lane_hist_4 = self.reconstruct_info(history_4)
        hdv_stats_hist_3, cav_stats_hist_3, all_lane_stats_3, _, _, _, self_stats_hist_3, exe_action_hist_3, gen_action_hist_3, surround_hdv_hist_3, surround_cav_hist_3, ego_lane_hist_3, left_lane_hist_3, right_lane_hist_3 = self.reconstruct_info(history_3)
        hdv_stats_hist_2, cav_stats_hist_2, all_lane_stats_2, _, _, _, self_stats_hist_2, exe_action_hist_2, gen_action_hist_2, surround_hdv_hist_2, surround_cav_hist_2, ego_lane_hist_2, left_lane_hist_2, right_lane_hist_2 = self.reconstruct_info(history_2)
        hdv_stats_hist_1, cav_stats_hist_1, all_lane_stats_1, _, _, _, self_stats_hist_1, exe_action_hist_1, gen_action_hist_1, surround_hdv_hist_1, surround_cav_hist_1, ego_lane_hist_1, left_lane_hist_1, right_lane_hist_1 = self.reconstruct_info(history_1)
        hdv_stats_current, cav_stats_current, all_lane_stats_0, road_structure_0, bottle_neck_0, target_0, self_stats_current, exe_action_current, gen_action_current, surround_hdv_current, surround_cav_current, ego_lane_current, left_lane_current, right_lane_current = self.reconstruct_info(current)
