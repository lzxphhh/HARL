...
def plot_training_curve_with_variance(event_paths, scalar_name='Value', label_name='algo_name', line_color='blue', window_size=10, p_alpha=0.2):
    ...
    plt.plot(steps, smoothed_mean, label=label_name, color=line_color)
...
# Usage
# collision rate
plt.figure(figsize=(18, 6)) # long figure
...
plot_training_curve_with_variance(event_paths, scalar_name='average_collision_rate', label_name='MAPPO', line_color='orange', window_size=5, p_alpha=0.2)
...
plot_training_curve_with_variance(event_paths, scalar_name='average_collision_rate', label_name='D-IADM w/o C-MDC', line_color='green', window_size=5, p_alpha=0.2)
...
plot_training_curve_with_variance(event_paths, scalar_name='average_collision_rate', label_name='D-IADM w/ C-MDC', line_color='red', window_size=5, p_alpha=0.2)

y_label='Mean Collision Rate'
plt.xlabel('No. of training steps', fontsize=18, color='black')
plt.ylabel(y_label, fontsize=18, color='black')
...
plt.xticks([0, 1000000, 2000000, 3000000], fontsize=18)
plt.yticks(fontsize=18)
plt.savefig('/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/plot_figure/figure_output/MAPPO_CR_long.png')
...
event_paths = ['/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/baseline/mappo/mappo_1/logs/events.out.tfevents.1718259184.liuzhengxuan-RESCUER-Y720-15IKB',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/baseline/mappo/mappo_2/logs/events.out.tfevents.1721017283.liuzhengxuan-RESCUER-Y720-15IKB',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/baseline/mappo/mappo_3/logs/events.out.tfevents.1721699264.liuzhengxuan-RESCUER-Y720-15IKB']  # Adjust with actual paths
plot_training_curve_with_variance(event_paths, scalar_name='average_episode_length', label_name='MAPPO', line_color='orange', window_size=5, p_alpha=0.2)

event_paths = ['/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR/mappo/mappo_1/logs/events.out.tfevents.1721197945.liuzhengxuan-RESCUER-Y720-15IKB',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR/mappo/mappo_2/logs/events.out.tfevents.1721651669.liuzhengxuan-RESCUER-Y720-15IKB',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR/mappo/mappo_3/logs/events.out.tfevents.1721672486.liuzhengxuan-RESCUER-Y720-15IKB']  # Adjust with actual paths
plot_training_curve_with_variance(event_paths, scalar_name='average_episode_length', label_name='D-IADM w/o C-MDC', line_color='green', window_size=5, p_alpha=0.2)

event_paths = ['/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR_DIU/mappo/mappo_1/logs/events.out.tfevents.1720678303.BugMakers',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR_DIU/mappo/mappo_2/logs/events.out.tfevents.1721393148.BugMakers',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR_DIU/mappo/mappo_3/logs/events.out.tfevents.1721455097.BugMakers']  # Adjust with actual paths
plot_training_curve_with_variance(event_paths, scalar_name='average_episode_length', label_name='D-IADM w/ C-MDC', line_color='red', window_size=5, p_alpha=0.2)
...
plt.xticks([0, 1000000, 2000000, 3000000], fontsize=18)
plt.yticks(fontsize=18)
plt.savefig('/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/plot_figure/figure_output/MAPPO_EL_long.png')
...
event_paths = ['/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/baseline/mappo/mappo_1/logs/events.out.tfevents.1718259184.liuzhengxuan-RESCUER-Y720-15IKB',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/baseline/mappo/mappo_2/logs/events.out.tfevents.1721017283.liuzhengxuan-RESCUER-Y720-15IKB',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/baseline/mappo/mappo_3/logs/events.out.tfevents.1721699264.liuzhengxuan-RESCUER-Y720-15IKB']  # Adjust with actual paths
plot_training_curve_with_variance(event_paths, scalar_name='train_episode_rewards', label_name='MAPPO', line_color='orange', window_size=5, p_alpha=0.2)

event_paths = ['/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR/mappo/mappo_1/logs/events.out.tfevents.1721197945.liuzhengxuan-RESCUER-Y720-15IKB',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR/mappo/mappo_2/logs/events.out.tfevents.1721651669.liuzhengxuan-RESCUER-Y720-15IKB',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR/mappo/mappo_3/logs/events.out.tfevents.1721672486.liuzhengxuan-RESCUER-Y720-15IKB']  # Adjust with actual paths
plot_training_curve_with_variance(event_paths, scalar_name='train_episode_rewards', label_name='D-IADM w/o C-MDC', line_color='green', window_size=5, p_alpha=0.2)

event_paths = ['/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR_DIU/mappo/mappo_1/logs/events.out.tfevents.1720678303.BugMakers',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR_DIU/mappo/mappo_2/logs/events.out.tfevents.1721393148.BugMakers',
               '/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/improve_HIAHR_DIU/mappo/mappo_3/logs/events.out.tfevents.1721455097.BugMakers']  # Adjust with actual paths
plot_training_curve_with_variance(event_paths, scalar_name='train_episode_rewards', label_name='D-IADM w/ C-MDC', line_color='red', window_size=5, p_alpha=0.2)
...
plt.xticks([0, 1000000, 2000000, 3000000], fontsize=18)
plt.yticks(fontsize=18)
plt.savefig('/home/spyder/projects/zhengxuan_projects/Mixed_traffic/HARL/examples/results/bottleneck/plot_figure/figure_output/MAPPO_ER_long.png')
