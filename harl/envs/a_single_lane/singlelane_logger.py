...
class SingleLaneLogger(BaseLogger):

    def __init__(self, args, algo_args, env_args, num_agents, writter, run_dir):
        super(SingleLaneLogger, self).__init__(
    ...
    def episode_log(
        ...
        self.writter.add_scalar(
            "train_episode_acceleration", average_episode_acceleration, self.total_num_steps
        )
        ...
        with open(self.csv_path, 'a', newline='') as csvfile:
            ...
            writer.writerow([self.total_num_steps, average_collision_rate, average_episode_step, average_episode_return, average_episode_speed, average_episode_acceleration])
