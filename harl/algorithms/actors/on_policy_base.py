...
class OnPolicyBase:
    ...
    def get_actions(
        ...
        """
        actions, action_log_probs, rnn_states_actor, prediction_error, action_loss = self.actor(
            obs, rnn_states_actor, masks, available_actions, deterministic
        )
        return actions, action_log_probs, rnn_states_actor, prediction_error, action_loss
    ...
    def act(
        ...
        Args:
            ...
            deterministic: (bool) whether the action should be mode of distribution or should be sampled.
        """
        actions, _, rnn_states_actor, prediction_error, action_loss = self.actor(
            obs, rnn_states_actor, masks, available_actions, deterministic
        )
